...
void Renderer3D::initBoxGL() {
    ...
    GLuint vert = loadShader(GL_VERTEX_SHADER,   "Engine/renderer/3d/shaders/box.vert");
    GLuint frag = loadShader(GL_FRAGMENT_SHADER, "Engine/renderer/3d/shaders/box.frag");
...
void Renderer3D::initShaders() {
    GLuint vert = loadShader(GL_VERTEX_SHADER,   "Engine/renderer/3d/shaders/atom.vert");
    GLuint frag = loadShader(GL_FRAGMENT_SHADER, "Engine/renderer/3d/shaders/atom.frag");
